...
static void split_message_text_into_lines(struct message_s message)
{
	/*
...
static void display_message(struct message_s message)
{
...
static void add_message_to_queue(struct message_s message)
{
	/*
...
static void remove_message_from_queue(struct message_s message)
{
	/*
...
void new_message(struct message_s message)
{
	/*
